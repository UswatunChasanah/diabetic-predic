...
if selected == "Dataset":
    ...
    4. Polydipsi : Digunakan untuk mengetahui apakah pasien merasa harus yang berlebihan atau tidak. Type data dari fitur polydipsi adalah kategorikal berupa Yes dan No.
    ...
    6. Weakness : Digunakan untuk mengetahui apakah pasien mengalami kelemahan di salah sisi tubuh atau tidak. Type data dari fitur weakness adalah kategorikal berupa Yes dan No.
...
if selected == "Implementasi":
    ...
    polyuria = st.radio("Apakah anda mengalamai Polyuria ?", ('Yes', 'No'))
    if polyuria == 'Yes':
        polyuria = 1
    elif polyuria == 'No':
        polyuria = 0

    polydipsia = st.radio("Apakah anda mengalamai Polydipsia ?", ('Yes', 'No'))
    if polydipsia == 'Yes':
        polydipsia = 1
    elif polydipsia == 'No':
        polydipsia = 0
    ...
    sudden_weight_loss = st.radio(
        "Apakah anda mengalamai sudden weight loss ?", ('Yes', 'No'))
    if sudden_weight_loss == 'Yes':
        sudden_weight_loss = 1
    elif sudden_weight_loss == 'No':
        sudden_weight_loss = 0

    weakness = st.radio("Apakah anda mengalamai weakness ?", ('Yes', 'No'))
    if weakness == 'Yes':
        weakness = 1
    elif weakness == 'No':
        weakness = 0

    polyphagia = st.radio("Apakah anda mengalamai Polyphagia ?", ('Yes', 'No'))
    if polyphagia == 'Yes':
        polyphagia = 1
    elif polyphagia == 'No':
        polyphagia = 0
    ...
    genital_thrush = st.radio(
        "Apakah anda mengalamai Genital thrush ?", ('Yes', 'No'))
    ...
    visual_blurring = st.radio(
        "Apakah anda mengalamai visual blurring ?", ('Yes', 'No'))
    if visual_blurring == 'Yes':
        visual_blurring = 1
    elif visual_blurring == 'No':
        visual_blurring = 0

    Itching = st.radio("Apakah anda mengalamai Itching ?", ('Yes', 'No'))
    if Itching == 'Yes':
        Itching = 1
    elif Itching == 'No':
        Itching = 0
    ...
    Irritability = st.radio(
        "Apakah anda mengalamai Irritability ?", ('Yes', 'No'))
    if Irritability == 'Yes':
        Irritability = 1
    ...
    delayed_healing = st.radio(
        "Apakah anda mengalamai delayed healing ?", ('Yes', 'No'))
    ...
    partial_paresis = st.radio(
        "Apakah anda mengalamai partial paresis ?", ('Yes', 'No'))
    ...
    muscle_stiffness = st.radio(
        "Apakah anda mengalamai muscle stiffness ?", ('Yes', 'No'))
    if muscle_stiffness == 'Yes':
        muscle_stiffness = 1
    elif muscle_stiffness == 'No':
        muscle_stiffness = 0

    Alopecia = st.radio("Apakah anda mengalamai Alopecia ?", ('Yes', 'No'))
    if Alopecia == 'Yes':
        Alopecia = 1
    elif Alopecia == 'No':
        Alopecia = 0

    Obesity = st.radio("Apakah anda mengalamai Obesity ?", ('Yes', 'No'))
    if Obesity == 'Yes':
        Obesity = 1
    elif Obesity == 'No':
        Obesity = 0
